...
namespace VirtoCommerce.CartModule.Test
{
    ...
    public class OrderTotalsCalculationTest
    {
        ...
        {
            var item1 = new LineItem { ListPrice = 10.20m, SalePrice = 9.12m, DiscountAmount = 1.33m, TaxPercentRate = 0.12m, Fee = 0.12m, Quantity = 2 };
            ...
            Assert.Equal(10.2144m, item1.SalePriceWithTax);
            Assert.Equal(9.12m, item1.PlacedPrice);
            Assert.Equal(18.24m, item1.ExtendedPrice);
            ...
            Assert.Equal(10.2144m, item1.PlacedPriceWithTax);
            Assert.Equal(20.4288m, item1.ExtendedPriceWithTax);
            Assert.Equal(2.9792m, item1.DiscountTotalWithTax);
            Assert.Equal(2.2032m, item1.TaxTotal);
