...
namespace VirtoCommerce.CartModule.Core.Model
{
    public class ShoppingCart : AuditableEntity, IHasTaxDetalization, IHasDynamicProperties, ITaxable, IHasDiscounts, ICloneable
    {
        ...
        public virtual int LineItemsCount { get; set; }
        ...
        public virtual string ObjectType => typeof(ShoppingCart).FullName;
        ...
        public virtual object Clone()
        {
            ...
            result.SharingSettings = SharingSettings?.Select(x => x.Clone()).OfType<CartSharingSetting>().ToList();
